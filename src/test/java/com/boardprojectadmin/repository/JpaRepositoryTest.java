...
class JpaRepositoryTest {
    ...
    @Test
    void givenNothing_whenSelecting_thenWorksFine() {
        // Given
    ...
    void givenAdminAccountAndRoleType_whenUpdating_thenWorksFine() {
        // Given
        AdminAccount adminAccount = adminAccountRepository.getReferenceById("kkm");
        ...
        assertThat(updatedAccount)
                .hasFieldOrPropertyWithValue("userId", "kkm")
